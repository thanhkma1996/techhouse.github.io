...
<div class="top-header">
  <div class="container">
  <div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6"> <span><i class="fa fa-phone"></i> 01689487864</span> <span><i class="fa fa-envelope-o"></i> <a href="mailto:support@mail.com">support@mail.com</a></span> </div>
...
<div class="container">
  <div class="row">
  <div class="col-xs-12 col-sm-12 col-md-3 logo "> <a href="index.php"> <img src="public/frontend/100/047/633/themes/517833/assets/logo.png" alt="TechHouse" title="TechHouse" class="img-responsive"> </a> </div>
  ...
  <div class="col-xs-12 col-sm-12 col-md-3 mini-cart">
    ...
    <div class="content-mini-cart">
      ...
      <ul class="list-unstyled">
        ...
        <div class="image"> <a href="index.php?quanly=cart"> <img alt="Sản phẩm 2" src="public/upload/product/1494416685000000000010021355-may-tinh-xach-tay-lenovo-ideapad-flex-2-14e284.jpg" title="Sản phẩm 2" class="img-responsive"> </a> </div>
        <div class="info">
      ...
      <a href="index.php?quanly=checkout" class="button">Thanh toán</a> </div>
    </div>
    </div>
  </div>
  </div>
